...
import GeneCISImg from "../../assets/GeneCIS.jpg";
        ...
        <div>
          <div style={{ display: "flex", marginTop: "2%" }}>
            <div
              ...
              {/* <img src={GeneCISImg} style={{width: "7vw",marginTop: "5%"}}/> */}
          ...
          <div style={{ color: "#667085", fontSize: "14px", marginTop: "2%" }}>
            ...
            Gene CIS optimizes chemical inventory management by digitizing
            legacy data, enabling chemists to seamlessly integrate and utilize
            historical chemicals. It tracks the lifecycle of chemicals,
            including procurement, storage, handling, usage, cleanup, and
            disposal. The system provides detailed insights into chemical usage,
            expiry dates, and inventory status through its dashboard and MIS
            reports, enhancing accuracy and operational efficiency.
          </div>
          </div>
