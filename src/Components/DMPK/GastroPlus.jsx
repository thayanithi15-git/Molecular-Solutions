...
import GastroPluesImg from "../../assets/Gstroplus_Logo.png";
...
export default function GastroPlus() {
  ...
  return (
    <div className="right-contents-products" style={{width: "100%"}}>
      <div className="right-sub-contents" style={{width: "100%"}}>
        <div>
          <div style={{ display: "flex", marginTop: "0%" }}>
            <div
             className="title-productspage">
              {/* <img src={GastroPluesImg} style={{width: "3vw",marginTop: "5%"}}/> */}
